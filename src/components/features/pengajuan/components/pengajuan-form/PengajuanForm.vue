...
<template>
  <div class="container p-10 flex flex-col md:w-[40%]">
    <div class="pb-8 mb-5">
        ...
        <p class="mt-2 text-gray-400 text-sm">Tolong masukan data diri, untuk pengajual awal</p>
    </div>

    <div class="flex flex-col gap-y-3 w-full">
        <BaseInput id="name" disabled label="Nama" placeholder="Masukan Nama" v-model:model-value="nameRef">
            
        </BaseInput>

        <BaseInput id="email" disabled label="Email" placeholder="Masukan Email" v-model:model-value="emailRef">
            
        </BaseInput>

        <BaseInput id="phone" label="Nomor HP" placeholder="Masukan HP" v-model:model-value="phoneRef">
            
        </BaseInput>

        <BaseInput id="address" label="Alamat" placeholder="Masukan Alamat" v-model:model-value="addressRef">
        ...
        <BaseInput id="jaminan" label="Jaminan Pinjaman" placeholder="Masukan Jaminan" v-model:model-value="jaminanRef">
        ...
        <BaseInput container-class-name="mb-4" id="alasan" label="Alasan Pengajuan" placeholder="Masukan Alasan Pengajuan" v-model:model-value="alasanRef">
