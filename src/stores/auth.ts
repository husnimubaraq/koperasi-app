...
import type { TLoginForm, TRegisterForm, TAuth, TUpdateForm } from '~/types/auth.interface'
...
export const useAuthStore = defineStore('auth', {
    ...
    actions: {
        async getProfile() {
            try {
                const response = await api.get<TResponseSingle<TLoginErrors, TUser>>('profile')
        ...
        async updateProfile(params: TUpdateForm) {
            try {
                const response = await api.post<TResponseSingle<TRegisterErrors, {}>>('update-profile', params)
        ...
        async login(params: TLoginForm) {
            try {
                const response = await api.post<TResponseSingle<TLoginErrors, TAuth>>('login', {
        ...
        async register(params: TRegisterForm) {
            try {
                const response = await api.post<TResponseSingle<TRegisterErrors, TAuth>>('register', params)
